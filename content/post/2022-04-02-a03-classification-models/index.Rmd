...
train <- read_csv("C:/Users/prana/Downloads/train.csv")
test <- read_csv("C:/Users/prana/Downloads/test.csv")
submission <- read_csv("C:/Users/prana/Downloads/submission.csv")
attach(train)
```
...
```{r}
model <- glm(formula = Survived~Pclass+Sex+SibSp+Age, data = train, family = 'binomial')
summary(model)
```

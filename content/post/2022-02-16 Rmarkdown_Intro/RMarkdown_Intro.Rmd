...
## Embed Images
"image: ![](nyu.jpeg){width=50%} this directory does not exist, if you want an actual image put the actual image file path whre it says nyu jpeg then delete everything inside the quotes starting from this"
